 ...
 * Elle permet l’ajout, la suppression, la modification et l’échange d’éléments.
 */
public class ListeSimple {
    ...
    /**
     * Modifie toutes les occurrences d’un élément donné.
     * @param element l’élément à rechercher
     * @param nouvelleValeur la valeur à assigner
     */
     ...
     * @return une chaîne contenant tous les nœuds de la liste
     */
    ...
    /**
     * Supprime toutes les occurrences d’un élément donné.
     * @param element l’élément à supprimer
     */
     ...
     * @param element l’élément à supprimer
     * @param tete la tête actuelle de la sous-liste
     * @return la tête modifiée après suppression
     */
     ...
     * @return le nœud avant le dernier, ou {@code null} si la liste est trop courte
     */
